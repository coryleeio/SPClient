...
namespace ExitGames.Client.Photon.LoadBalancing
{
    ...
    public class LoadBalancingClient : IPhotonPeerListener
    {
        ...
        /// <summary>Joins the lobby on the Master Server, where you get a list of RoomInfos of currently open rooms. </summary>
        ...
        /// \deprecated Use version with TypedLobby parameter.
        /// <summary>
        ...
        /// <summary>
        /// See OpSetCustomPropertiesOfRoom(Hashtable gameProperties, bool webForward, Hashtable expectedProperties = null).
        /// </summary>
        [Obsolete("Use: OpSetCustomPropertiesOfRoom(Hashtable gameProperties, bool webForward, Hashtable expectedProperties = null)")]
        public bool OpSetCustomPropertiesOfRoom(Hashtable gameProperties, Hashtable expectedProperties = null)
        {
            return this.OpSetCustomPropertiesOfRoom(gameProperties, false, expectedProperties);
        }
                ...
                case OperationCode.Authenticate:
                    {
                        ...
                        else if (this.Server == ServerConnection.GameServer)
                        {
                            ...
                            {
                                this.State = ClientState.Joining;
                                this.OpJoinOrCreateRoom(this.CurrentRoom.Name, this.lastJoinActorNumber, this.createRoomOptions, this.CurrentLobby);
                            }
        ...
        public virtual void OnEvent(EventData photonEvent)
        {
            switch (photonEvent.Code)
            {
                ...
                case EventCode.GameListUpdate:
                    ...
                    {
						UnityEngine.Debug.Log(gameName);
